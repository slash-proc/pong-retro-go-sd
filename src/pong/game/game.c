...
static void process_input_demo(void);
static void update(void);
static void update_demo(void);
static void update_player(void);
static void update_player_demo(void);
static void update_ball(void);
static void update_ai(void);
static void update_ai_demo(void);
static void update_score(int score);

#define randint(min, max) (pong_rand() % ((max) + 1 - (min)) + (min))
#define randsing()        (pong_rand() > 16384 ? -1 : 1)
...
static void build_sprite_list(void)
{
	sprite_slots[0] = &paddle1;
	sprite_slots[1] = &paddle2;
	sprite_slots[2] = &ball1;
	sprite_slots[3] = &ball2;
	sprite_slots[4] = &ball3;
	sprite_slots[5] = &ball4;
	sprite_slots[6] = NULL;
	list = sprite_slots;
}
